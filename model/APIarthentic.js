        ...
        if(err){
           ...
           connection.query(query2,function(err2,temp){
             if(err2){
               ...
               var totalPendapatan = Number(totalHarga-modal);
               ...
               connection.query(query3,function(err3,succ){
                 if(err3){
                   res.json({"message":"gagal mendapatkan total pendapatan bersih"+query3});
                 }
                 else{
                   res.json({"message":"berhasil mendapatkan total pendapatan bersih"+query3});
                 }
